		...
		>
			<div className={styles.inner}>
				<Link href="/" className={styles.logo} onClick={closeMenu}>
					...
					<span>
						gr<span className={styles.logoAccent}>í</span>t
					</span>
				</Link>
				...
				<div className={styles.links} role="list">
					{NAV_LINKS.map((l) => {
						...
						if (isDocs) {
							return (
								<div key={l.href} className="nav-docs-wrapper hero-docs-wrapper">
									{content}
									<NavDocsPreview />
								</div>
							);
				...
				<div className={styles.actions}>
					<a
						...
						className={`${styles.github} hero-docs-wrapper`}
						target="_blank"
					...
					<a
						href="https://github.com/rawadhossain/grit-cli/"
						className={styles.projectSource}
						target="_blank"
						rel="noopener noreferrer"
						id="nav-project-source"
					>
						Explore Source ↗
					</a>
				</div>
...
function NavDocsPreview() {
	...
	return (
		<div className="hero-docs-preview hero-docs-preview--nav" aria-hidden="true">
